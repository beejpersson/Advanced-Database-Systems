...
insert into employeeTable values (name_typ('Mr', 'Deborah', 'Marshall'), address_typ('Basil', 'Seka', 'KZ6 QH8'), phone_typ('66-(494)846-9327', mobilePhones_nested('48-(247)342-6376', '86-(719)169-0074')), 2474835, 301, 351, job_typ('Manager', 52111, (SELECT REF(b) FROM branchTable b WHERE b.bID = 4), '13-Jan-2016'));
