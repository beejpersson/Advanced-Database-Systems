...
insert into employeeTable values (name_typ('Mr', 'Deborah', 'Marshall'), address_typ('Basil', 'Glasgow', 'KZ6 QH8'), phone_typ('66-(494)846-9327', mobilePhones_nested('48-(247)342-6376', '86-(719)169-0074')), 2474835, 301, 351, job_typ('Manager', 52111, (SELECT REF(b) FROM branchTable b WHERE b.bID = 4), '13-Jan-2016'));
...
insert into employeeTable values (name_typ('Mrs', 'Brandon', 'Edwards'), address_typ('Doe Crossing', 'Glasgow', 'HB5 VH3'), phone_typ('92-(518)754-8423', mobilePhones_nested('86-(180)136-1940')), 1987198, 305, 355, job_typ('Manager', 31439, (SELECT REF(b) FROM branchTable b WHERE b.bID = 17), '13-Sep-2016'));
...
insert into employeeTable values (name_typ('Mrs', 'Janice', 'Howard'), address_typ('Washington', 'Glasgow', 'ST3 ZA7'), phone_typ('48-(903)634-7572', mobilePhones_nested('51-(781)751-0589')), 4372273, 313, 363, job_typ('Cashier', 59101, (SELECT REF(b) FROM branchTable b WHERE b.bID = 16), '18-Nov-2009'));
...
insert into employeeTable values (name_typ('Mrs', 'Brendon', 'Ramos'), address_typ('Mosinee', 'Ransang', 'ZI9 UC4'), phone_typ('63-(164)440-8426', mobilePhones_nested('46-(347)996-1471')), 4946417, 316, 366, job_typ('Leader', 41355, (SELECT REF(b) FROM branchTable b WHERE b.bID = 2), '29-Mar-2003'));
...
insert into employeeTable values (name_typ('Rev', 'Jason', 'Armstrong'), address_typ('Pearson', 'Glasgow', 'KU3 ER3'), phone_typ('62-(162)819-2961', mobilePhones_nested('502-(289)221-5794')), 4069936, 318, 368, job_typ('Head', 20029, (SELECT REF(b) FROM branchTable b WHERE b.bID = 1), '11-Apr-2004'));
