...
insert into employeeTable values (name_typ('Mr', 'Deborah', 'Marshall'), address_typ('Basil', 'Glasgow', 'KZ6 QH8'), phone_typ('66-(494)846-9327', mobilePhones_nested('48-(247)342-6376', '86-(719)169-0074')), 2474835, 301, (SELECT REF(e) FROM employeeTable e WHERE e.empID = 319), job_typ('Manager', 52111, (SELECT REF(b) FROM branchTable b WHERE b.bID = 4), '13-Jan-2016'));
...
insert into employeeTable values (name_typ('Dr', 'Willie', 'Smith'), address_typ('Fair Oaks', 'Pingpo', 'MC7 GI9'), phone_typ('86-(991)265-7988', mobilePhones_nested('48-(731)108-8030')), 1377578, 309, (SELECT REF(e) FROM employeeTable e WHERE e.empID = 317), job_typ('Leader', 51307, (SELECT REF(b) FROM branchTable b WHERE b.bID = 6), '30-Jul-2013'));
