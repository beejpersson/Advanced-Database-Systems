...
SELECT count(a.accType) AS "Number of Savings Accounts", a.bID.bAddress.street AS "Branch Street", a.bID.bAddress.city AS "Branch City", a.bID.bAddress.p_code AS "Branch Post Code" FROM accountTable a WHERE a.accType = 'savings';